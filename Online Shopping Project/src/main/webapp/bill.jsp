<%@page import="org.eclipse.jdt.internal.compiler.ast.Wildcard"%>
...
try{
 ...
 ResultSet rs2 =st.executeQuery("select * from userss inner join cart where cart.email = '"+email+"' and cart.status = 'bill'");
 while(rs2.next()){
	
%>
<h3>Online shopping Bill (Manish & Company)</h3>
<hr>
