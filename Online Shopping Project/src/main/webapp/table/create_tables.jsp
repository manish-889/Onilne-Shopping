...
try{
	...
	String q1 = "CREATE TABLE userss (name VARCHAR(100), email VARCHAR(100) PRIMARY KEY, mobileNumber BIGINT, securityQuestion VARCHAR(200), answer VARCHAR(200), password VARCHAR(100), address VARCHAR(500), city VARCHAR(100),state VARCHAR(100),country VARCHAR(100))";
