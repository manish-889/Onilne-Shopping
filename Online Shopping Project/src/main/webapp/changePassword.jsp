...
<h3>Enter Confirm Password</h3>
 <input class="input-style" type="password" name="confrimPassword" placeholder="Enter Confirm Password" required> 
<hr>
<button class="button" type="submit">Save <i class="fa fa-solid fa-arrow-right"></i></button>
</form>
</body>
<br><br><br>
</html>