...
<body>
<div style="color: white; text-align: center; font-size: 30px;">Message Us <i class="fa fa-solid fa-comment"></i></div>
<%
...
<hr>
<button class="button" type="submit">Send <i class="fa fa-solid fa-arrow-right"></i></button> 
</form>
<br><br><br>
</body>
</html>