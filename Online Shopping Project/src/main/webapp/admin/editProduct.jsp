...
<body>
 <h2><a class="back" href="allProductEditProduct.jsp"><i class="fa fa-solid fa-arrow-left"></i> Back</a></h2>
<% 
...
<option value="No">No</option>
 ...
 <button class="button">Save <i class="fa fa-solid fa-arrow-right"></i></button>
</form>
