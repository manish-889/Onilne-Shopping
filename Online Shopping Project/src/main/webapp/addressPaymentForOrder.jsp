...
%>
          <tr>
          <th scope="col"><a href="myCart.jsp"><i class="fa-solid fa-arrow-left"> Back</i></a></th>
   	...
   	<%
         ...
         <%
      	...
      	ResultSet rs2  = st.executeQuery("select * from userss where email = '"+email+"'");
      	while(rs2.next()){
...
<div class="right-div">
<h3>Pay online on this Mansih&Comapany@pay.com</h3>
...
<button class="button" type="submit">Procced to Generate Bill & Save <i class="fa fa-solid fa-arrow-right"></i></button>
